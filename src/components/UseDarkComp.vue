...
console.log(pageConfig.pageConfig.isDark)

const toggleDarkModel = computed({
    get: () => pageConfig.pageConfig.isDark,
    set: () => {}
})
</script>
<template>
    <label id="theme-toggle-button">
        <input type="checkbox" id="toggle" v-model="toggleDarkModel" @click="toggleDark" />
        <svg
            viewBox="0 -1 80 44"
        ...
        >
            <g transform="translate(3.5 3.5)" data-name="Component 15 – 1" id="Component_15_1">
                ...
                <g fill="#def8ff" transform="translate(3.585 1.325)" id="stars">
                    ...
                    ></path>
                    <path
                        transform="matrix(0.5, 0.866, -0.866, 0.5, 10, 20)"
                        d="M0.5,0 L0.45,0.55 L0,0.5 L0.4,0.9 L0.35,1.45 L0.5,1 L0.65,1.45 L0.6,0.9 L1,0.5 L0.55,0.55 Z"
                        data-name="star"
                    ></path>
                    <path
                        transform="translate(15 5) rotate(-30)"
                        d="M0.5,0 L0.45,0.55 L0,0.5 L0.4,0.9 L0.35,1.45 L0.5,1 L0.65,1.45 L0.6,0.9 L1,0.5 L0.55,0.55 Z"
                        data-name="star"
                    ></path>
                    <path
                        transform="matrix(-0.5, 0.866, -0.866, -0.5, 20, 10)"
                        d="M0.5,0 L0.45,0.55 L0,0.5 L0.4,0.9 L0.35,1.45 L0.5,1 L0.65,1.45 L0.6,0.9 L1,0.5 L0.55,0.55 Z"
                        data-name="star"
                    ></path>
                </g>
...
#toggle:checked + svg #button {
    transform: translate(36px, 2.333px);
}
